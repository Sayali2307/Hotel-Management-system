...
public class Hotel {
	...
	public String toString() {
		return "Hotel [hotel_id=" + hotel_id + ", hotel_name=" + hotel_name + ", hotel_gst=" + hotel_gst
				+ ", hotel_address=" + hotel_address + ", hotel_owner=" + hotel_owner + ", hotel_manager="
				+ hotel_manager + ", hotel_rating=" + hotel_rating + "]";
	}
